...
\begin{frame}
	...
	feature selection, con SMOTE, no cost sensitivity, sembra avere l'F1-score migliore}.
...
\begin{frame}
	...
	learning.
	\textbf{IBk sembra avere il kappa migliore, 
...
\begin{frame}
	...
	sembra avere l'AUC migliore} in questo caso: è vero che, ad esempio, rispetto
