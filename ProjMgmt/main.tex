...
\begin{frame}
	...
	\begin{itemize}
		...
		Random Forest si tende a registrare un costo più basso. Una eventuale scelta comunque, ricadrebbe su IBk,
		...
		conviene sicuramente utilizzare IBk con feature selection (best first backward), no balancing e 
	...
	\begin{itemize}
		...
		\item La prima iterazione di walk forward non viene mai eseguita
	\end{itemize}
