...
\begin{document}
	...
	{quello a 3 argomenti} e il FileChannel è soggetto a mocking per
	 evitare di avere a che fare con il filesystem, lettura di file, 
	 setup e cleanup dopo ogni test.
	...
	\ceqtable{read}{BufferedChannel}{1}{\bookkeeper}{
			\tcell{dest} & \tcell{\ceq{null}\\\ceq{buffer di destinazione}}
		\newtrow
	...
	\bvtable{read}{BufferedChannel}{1}{\bookkeeper}{
		...
		\newtrow
			\tcell{dest} & \tcell{\ceq{buffer di destinazione}} & \tcell{ByteBuf()}
		\newtrow
