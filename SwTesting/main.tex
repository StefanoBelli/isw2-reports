...
\begin{document}
	...
	\textit{"Lista di timestamp: $\{\dots,e_i,\dots\}$"} si intende una lista che contiene il timestamp
	dell'evento $i$-esimo $\forall i$, nello stesso ordine presentato nell'esito atteso, 
	\textit{"Lista di timestamp vuota"} è autoesplicativa.
