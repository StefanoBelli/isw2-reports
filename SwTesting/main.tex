...
\begin{document}
	...
	"che cosa succede se si aggiungono ulteriori eventi (tramite uno degli
	overload del metodo 
	...
	proprio nell'add invocata dal test case e gli insiemi expired e newEvents vengono intercettati IN QUEST'ULTIMA 
	invocazione di onActivation e onExpiry, e quindi confrontati con quanto ci si aspetta sia presente al momento.
