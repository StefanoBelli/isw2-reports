...
\begin{document}
	...
	branch coverage della classe (risp. 59\%, 55\%), mentre in figura \ref{\getpicturelabel{storm/mutation-WindowedBoltExecutor-2}} si osserva
	un miglioramento della strength della test suite (lncov: 62\%, mutcov: 57\%, test str.: 87\%).
	...
	\makepicture{17cm}{9cm}{storm/second-iter-WindowedBoltExecutor-reason}
